...
async function loadDatabaseSchema(_state: ChatbotState): Promise<Partial<ChatbotState>> {
  try {
    ...
    // Create simple schema based on known tables
    const schema: DatabaseSchema = {
      'student_stress_levels': {
        ...
        description: 'Student stress levels data with anxiety measurements and related factors',
      },
      'student_stress_survey': {
        ...
        description: 'Student stress survey responses and measurements',
      }
    };
